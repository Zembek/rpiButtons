...
using RPiButtons.SSD1306.Common;
using RPiButtons.SSD1306.Core.DisplayFont;
using System;
...
namespace RPiButtons.SSD1306.Core
{
    public class Display
    {
        ...
        private readonly byte[] SerializedDisplayBuffer =
        ...
        public bool IsInitialized => displayI2c != null;
        ...
        public async void Init(DisplayConfiguration configuration)
        {
            ...
            try
            {
                ...
                I2cConnectionSettings settings = new I2cConnectionSettings(0, SSD1306_Default_Address);
